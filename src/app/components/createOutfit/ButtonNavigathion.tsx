  ...
  return (
    <div className="mb-6">
      <button
        ...
        className="bg-white hover:bg-gray-50 text-gray-800 font-semibold py-1 px-6 rounded-lg shadow-sm transition-colors duration-200 flex items-center gap-2 ml-auto"
      >
